-- 000003: provider/route/account rate/capacity configuration and routing policy KV
-- Adds nullable numeric configuration fields only. NULL means inherit/default/unlimited.
