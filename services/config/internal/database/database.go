// Package database provides the PostgreSQL connection for the config service
...
// changes are managed by versioned SQL migrations in services/config/migrations,
