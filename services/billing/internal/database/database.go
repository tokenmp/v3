// Package database provides the PostgreSQL connection for the billing service
...
// changes are managed by versioned SQL migrations in services/billing/migrations,
