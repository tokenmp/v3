// Package database provides the PostgreSQL connection for the logging service
...
// changes are managed by versioned SQL migrations in services/logging/migrations,
